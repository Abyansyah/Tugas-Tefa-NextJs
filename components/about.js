  ...
  return (
    <>
      <section className={styles.detail}>
        <h1 data-aos="fade-down" className={styles.heading}>Superiority</h1>
        <div className={styles.container}>
          <div data-aos="fade-up-right" className={styles.left}>
          ...
          <div data-aos="fade-up-left" className={styles.right}>
